		...
		<Form className="order-ticket-form" onSubmit={submitForm}>
			<Row>
				<Col xs="12" md="6">
					{isError && (
						<Alert color="warning">
							There are some errors in you form. Have you fill all
							the fields? Maybe you forgot to choose your seat?
						</Alert>
					)}
					{requests['ADD_SEAT'] &&
					...
					{requests['ADD_SEAT'] &&
						...
						!isError && (
							<Alert color="success">
								You've booked your ticket! Check you email in
					...
					<FormGroup>
						...
						<small id="dayHelp" className="form-text text-muted">
							Every day of the festival uses individual ticket.
							You can book only one ticket at the time.
						</small>
					</FormGroup>
					<FormGroup check>
						<Label check>
